...
%-------------------------------------------------------------------------------
\begin{cvparagraph}
Quantum error correction researcher focused on proving the theoretical limits of QLDPC codes, with a keen eye for fault-tolerance. Coming from an engineering background has imbued in me a deep interest in the practical implications of my work, and how experts across disciplines may come together to create a fault-tolerant quantum world. Above all else, a lover of the beauty of mathematics.
\end{cvparagraph}
