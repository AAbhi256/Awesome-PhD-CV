...
\item M. Seo, \textbf{H. Lim} et al., ``BUFFER-X: Towards Zero-Shot Point Cloud Registration in Diverse Scenes,'' \textit{IEEE/CVF ICCV}, 2025.
\item \textbf{H. Lim} et al., ``ERASOR2: Instance-Aware Robust 3D Mapping of the Static World in Dynamic Scenes,'' \textit{RSS}, 2023.
\item \textbf{H. Lim} et al., ``Quatro++: Robust Global Registration Exploiting Ground Segmentation for Loop Closing in LiDAR SLAM,'' \textit{IJRR}, 2023.
\item \textbf{H. Lim} et al., ``Patchwork: Concentric Zone-Based Region-Wise Ground Segmentation With Ground Likelihood Estimation Using a 3D LiDAR Sensor,'' \textit{IEEE RA-L w/ IROS}, 2021.
\item \textbf{H. Lim} et al., ``ERASOR: Egocentric Ratio of Pseudo Occupancy-Based Dynamic Object Removal for Static 3D Point Cloud Map Building,'' \textit{IEEE RA-L w/ ICRA}, 2021.
\end{tightemize}
\sectionsep
